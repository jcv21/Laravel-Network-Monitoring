...
<div class="text-center">
    <form action="{{ route('download') }}" method="post">
        @csrf
        <input type="hidden" id="report_name" name="report_name" value="{{ $data['title'] }}">
        <input type="hidden" name="report_start_date" id="report_start_date" value="{{ $data['date_from'] }}">
        <input type="hidden" name="report_end_date" id="report_end_date" value="{{ $data['date_to'] }}">
        <input type="hidden" name="InputSDate" id="InputSDate" value="{{ $data['InputSDate'] }}">
        <input type="hidden" name="InputEDate" id="InputEDate" value="{{ $data['InputEDate'] }}">
        <input type="hidden" name="InputReportType" id="InputReportType" value="{{ $data['type'] }}">
